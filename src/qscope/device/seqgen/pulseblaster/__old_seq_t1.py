...
def seq_t1(
    ...
    **kwargs,
    ...
    logger.info(
        "Programming T1 sequence with the following parameters:"
    ...
    for tau in time_list:
        ...
        # pb.add_pulse(["rf_trig"], trigger_time) # turn laser on??
...
def seq_sig(
    ...
    # Add the dark time
    pb.add_pulse([], tau, loop="end", inst=inst_sig, const_trigger=const_trigger)
...
def ref_sig_pi_at_start(
    ...
    # Add π pulse
    pb.add_pulse(["mw_x"], rf_dur, delay=rf_delay, const_trigger=const_trigger)
