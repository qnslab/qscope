...
from qscope.types import MAIN_CAMERA, PRIMARY_RF, SEQUENCE_GEN, SGAndorSpinEchoConfig
...
class SGAndorSpinEcho(SGCameraMeasurement):
    x_label = "Time (s)"
    y_label = "PL (counts)"
    _acq_mode = ACQ_MODE.SINGLE_MEAS
    _meas_config_type = SGAndorSpinEchoConfig
    meas_config: SGAndorSpinEchoConfig  # I've overriden just to give my IDE type info
    ...
    def _prepare(self, continue_prev=False) -> tuple:
        ...
        # FIXME I assume diff params for SE?
