...
from .base import analyze_mpl_response, managed_devices, setup_logging
...
@click.option(
    "--detrend/--no-detrend",
    default=False,
    help="Remove linear trend from PL signal (corrects for photobleaching)",
)
@optgroup.group("Measurement Parameters")
@optgroup.option(
    "--current",
    "-c",
    type=float,
    default=0.1,
    help="Peak current amplitude in amps (default: 0.1)",
)
@optgroup.option(
    "--frequency",
    "-f",
    type=float,
    default=1.0,
    help="Operational frequency in Hz (default: 1.0)",
)
@optgroup.option(
    "--duration",
    "-d",
    type=float,
    default=-1,
    help="Measurement duration in seconds (defaults to 1/f)",
)
@optgroup.option(
    "--averages",
    "-a",
    type=int,
    default=1,
    help="Number of measurement sequences to average (default: 1)",
)
...
@optgroup.option(
    ...
    type=float,
    default=0.5,
    help="Voltage range for PL channel in V (default: 0.5)",
)
@optgroup.option(
    "--pl-coupling",
    type=click.Choice(["AC", "DC"]),
    default="DC",
    help="PL channel coupling (default: DC)",
)
@optgroup.option(
    "--trigger-threshold",
    type=float,
    default=2.5,
    help="Scope trigger threshold in volts (default: 2.5)",
)
@optgroup.option(
    "--downsample-ratio",
    "-dr",
...
@optgroup.option(
    "--trigger-source",
    type=click.Choice(["FREE", "CLOCK"]),
    default="CLOCK",
    help="Scope trigger source (default: FREE)",
)
@optgroup.option(
...
@optgroup.group("Plotting Parameters")
@optgroup.option(
    "--fit/--no-fit",
    default=False,
...
@optgroup.option(
    ...
    default=False,
    help="Plot detailed pulse analysis for each transition (default: disabled)",
)
@optgroup.group("Saving/Output")
@optgroup.option(
    "--save/--no-save",
    default=True,
    help="Save measurement data to file (default: enabled)",
)
@optgroup.option(
